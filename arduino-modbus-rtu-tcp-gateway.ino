...
/****** ADVANCED SETTINGS ******/
SoftwareSerial rs485_Serial(3, 2); // add this!
...
#define mySerial rs485_Serial // Serial              // define serial port for RS485 interface, for Arduino Mega choose from Serial1, Serial2 or Serial3         
#define RS485_CONTROL_PIN 4          // Arduino Pin for RS485 Direction control, disable if you have module with hardware flow control
